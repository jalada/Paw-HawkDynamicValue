...
hawk.client = {
    ...
    */
    ...
    header: function header(uri, method, options) {
        ...
        if (!uri || typeof uri !== 'string' && (typeof uri === 'undefined' ? 'undefined' : typeof(uri)) !== 'object' || !method || typeof method !== 'string' || !options || (typeof options === 'undefined' ? 'undefined' : typeof(options)) !== 'object') {
    ...
    */
    ...
    bewit: function bewit(uri, options) {
        ...
        if (!uri || typeof uri !== 'string' || !options || (typeof options === 'undefined' ? 'undefined' : typeof(options)) !== 'object' || !options.ttlSec) {
    ...
    */
    ...
    message: function message(host, port, _message, options) {
        ...
        if (!host || typeof host !== 'string' || !port || typeof port !== 'number' || _message === null || _message === undefined || typeof _message !== 'string' || !options || (typeof options === 'undefined' ? 'undefined' : typeof(options)) !== 'object') {
